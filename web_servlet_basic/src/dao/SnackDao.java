...
//수정
	public SnackDto getSnackUpdate(String p_code) {
		SnackDto dto = null;
		String query = "select s.p_code, s.p_name,\r\n" + 
				"        c.m_code, c.m_name, \r\n" + 
				"        to_char(s.price,'999999') as price\r\n" + 
				"from h_최선우_snack s,\r\n" + 
				"    commonsnack c\r\n" + 
				"where s.m_code = c.m_code\r\n" + 
				"and s.p_code = '"+p_code+"'";
...
//회사조회
	public ArrayList<SnackDto> getSnackList(String select,String search,String radio){
