			...
			<table class="boardForm">
				...
				<tbody>
					...
					<tr>
						<th>우선순위</th>
						<td colspan="3">
							<input type="radio" value="1" name="t_priority" <c:if test="${t_dto.getPriority() eq '1'}"> checked</c:if>> 1&nbsp;&nbsp;  
							<input type="radio" value="2" name="t_priority" <c:if test="${t_dto.getPriority() eq '2'}"> checked</c:if>> 2&nbsp;&nbsp;  
							<input type="radio" value="3" name="t_priority" <c:if test="${t_dto.getPriority() eq '3'}"> checked</c:if>> 3
						</td>
					</tr>	
					<tr>
						<th>사이즈</th>
